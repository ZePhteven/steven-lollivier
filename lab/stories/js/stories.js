...
var stories = {
  ...
  /* navigation */ get: function (storyId) {
    $.getJSON("data/" + storyId + ".json", function (data) {
  ...
  /* navigation */ set: function () {
    $(".story-container .page").html(
      stories.currentStory.chapters["chapter-" + stories.currentPage].content
    );
    $(".page-number").html(
      "Page " + (stories.currentPage + 1) + "/" + stories.pagesNumber
    );
  },
